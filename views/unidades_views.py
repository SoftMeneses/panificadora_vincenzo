...
class App:
    ...
    def create_table(self, parent):
        ...
        tree.heading("id_und_med", text="ID Unidad", anchor="center")
        tree.heading("descr_und", text="Descripción", anchor="w")
        
        tree.column("id_und_med", width=120, anchor="center")
        tree.column("descr_und", width=250, anchor="w")
